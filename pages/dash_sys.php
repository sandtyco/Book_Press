...
// UBAH: Role 1 (Administrator) yang diizinkan
check_role_access([1]); 

$current_user_id = $_SESSION['id_user'];
// UBAH NAMA VARIABEL DAN HEADLINE SESUAI CONTEXT ADMINISTRATOR
$administrator_data = [];
        ...
        <div class="col-md-5" style="margin-top: 5px;">
            <div class="panel panel-primary">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="glyphicon glyphicon-user"></span> Profil Administrator</h3>
                </div>
